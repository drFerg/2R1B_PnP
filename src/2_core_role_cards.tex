...
\redcard{Martyr}{Spare Bomb!}{
	...
	\character{Bomber} dies, or is not in the game, you take their
	responsibilities.
	\\\vspace{0.5cm}
...
\bluecard{Vice-President}{The right hand man!}{
	...
	\character{President} dies, or is not in the game, you take their
	responsibilities.
}
\redcard{Tinkerer}{Not quite engineer!}{ 
	You are the backup for the \character{Engineer}: If the
	\character{Engineer} dies, or is not in the game, you take their
	responsibilities.
	\\\vspace{0.4cm} 
	The \character{Bomber} must card share with the \character{Engineer} in
	order to explode.
...
\bluecard{Nurse}{Get me 50cc, stat!}{
	...
	\character{Doctor} dies, or is not in the game, you take their
	responsibilities.
	\\\vspace{0.5cm} 
	The \character{President} must card share with the \character{Doctor}
	to not die at the end of the game.
